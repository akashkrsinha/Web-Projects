...
export default function Experience() {
    ...
    function submit() {
        // obj2.jobTitle = form2.jobTitle;
        // obj2.company = form2.company;
        // obj2.city = form2.city;
        // obj2.country = form2.country;
        // obj2.startMonth = form2.startMonth;
        // obj2.startYear = form2.startYear;
        // obj2.endMonth = form2.endMonth;
        // obj2.endYear = form2.endYear;
  ...
  return (
        ...
        <div className={style.experienceContainer}>
            <form>
                ...
                <div className={style.text2}>Start with your most recent position.</div>
                ...
                <select name="Month"  onChange={handelChange} name='startMonth' value={form2.startMonth}>
                    <option>Month</option>
                ...
                <select name="Year" onChange={handelChange} name='startYear' value={form2.startYear} >
                    {/* <option>year</option> */}
                ...
                <select name="Month" onChange={handelChange} name='endMonth' value={form2.endMonth}>
                    <option>Month</option>
                    <option value="january">january</option>
                    <option value="February">February</option>
                    <option value="March">March</option>
                ...
                <select name="Year" onChange={handelChange} name='endYear' value={form2.endYear}>
                    <option>year</option>
                    <option value="1940">1940</option>
                    <option value="1941">1941</option>
                    <option value="1942">1942</option>
